...
namespace NewsPortal.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(NewsPortalDbContext context)
        {
            _context = context;
        }
        ...
        {
            var newsPortalDbContext = _context.Users.Include(u => u.Role);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NewsPortalDbContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
